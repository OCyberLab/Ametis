...
#        print_green("-----------------")
  ...
  # print_green("-----------------")
    ...
    df_result["Dataset"][index] = train_dataset_name
    ...
    if count_label_0 > 0:  # To avoid division by zero
        ...
        ratio = None  # Or some other value indicating that the ratio is not defined

    # Assign values to new_row
    df_result.at[i, "Data Ratio(Attack / Normal)" ] = ratio
    df_result.at[i, "Data Rows" ] = df.shape[0]
    print_green("-----------------")
...
#        column_names = ["Dataset", "Feature Selection", "Scenario", "L2_Complexity", "F1_Complexity", "C1_Complexity", "C2_Complexity", "CM", "Data Ratio", "Data Rows"]
...
#
#        # Assign values to new_row
#        new_row["Data Ratio(Attack / Normal)"] = ratio
#        new_row["Data Rows"] = df.shape[0]
#
#
#        new_row["CM"] = CM
...
model_name = "BERT"
csv_path = "result_data_augmentation_result_BERT.csv"
