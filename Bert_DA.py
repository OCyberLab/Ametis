...
def preprocess_data_with_one_hot(df):
...
csv_file_path = f"results/DA/result_data_augmentation_result_BERT_IOT23_{scenario}_{feature_selection}_{model_name}.csv"
epochs = 1
...
for i, combination in enumerate(combinations):
    ...
    df_train = preprocess_data_with_one_hot(df_train)
    df_test = preprocess_data_with_one_hot(df_test)
